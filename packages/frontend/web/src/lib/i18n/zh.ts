...
export const zh = {
  ...
  "groups.composition.threeAria": "三方编制",
  "groups.composition.twoAria": "两方编制",
  "groups.task.running": "任务运行中",
  "groups.task.attention": "需要关注",
  "groups.task.complete": "已完成",
  "groups.task.none": "暂无任务",
  ...
  "groups.error.renameFailed": "重命名失败: {detail}",
  ...
  "groups.renamed": "群组已改名为「{title}」",
  "groups.renameAria": "重命名群组",
  "groups.renameInputAria": "新群组名称",
  "groups.renameSave": "保存名称",
  "groups.renameCancel": "取消改名",
  ...
  "participants.renameAria": "重命名参与者",
  "participants.renameInputAria": "新参与者名称",
  "participants.renameSave": "保存名称",
  "participants.renameCancel": "取消改名",
  "participants.renameBuiltinHint": "执行器名由配置管理",
  ...
  "tasks.output.fetchFailed": "拉取实时输出失败: {status}",
  "tasks.detail.fetchFailed": "拉取任务详情失败: {status}",
  "tasks.liveness.recent": "最近活动 · {when}",
  "tasks.liveness.justNow": "刚刚",
  "tasks.liveness.minutesAgo": "{n} 分钟前",
  "tasks.liveness.runningFor": "已运行 {duration}",
  ...
  "members.subtitle": "管理基本信息、项目绑定,以及成员与分工",
  "members.back": "返回消息流",
  "members.empty": "暂无成员",
  ...
  "members.promptPlaceholder": "例:负责代码审查,关注测试覆盖与可读性",
  "members.selectRoleHint": "请至少选择一个角色",
  ...
  "feedback.card.body":
    "反馈会直接进入项目的 GitHub Issues,方便我们追踪与修复。",
  "feedback.card.title": "项目 GitHub Issues",
  "feedback.open": "打开 Issues",
  "feedback.subtitle": "问题、建议或缺陷,欢迎提交到项目 Issue 跟踪器。",
  "feedback.title": "反馈",
  "help.features.body":
    "参与者注册身份 → 建群绑定项目 → 按角色/受众发消息 → 定向执行器下发任务 → 任务面板看实时进度与执行历史。",
  "help.features.title": "平台功能",
  "help.step.create.body": "输入任务名创建群组,创建者自动成为协调者。",
  "help.step.create.title": "1. 建群",
  "help.step.message.body": "广播给全员,或定向给某个参与者(如执行器)。",
  "help.step.message.title": "2. 发消息",
  "help.step.project.body": "群可绑定项目路径,执行器在该目录干活。",
  "help.step.project.title": "5. 绑定项目",
  "help.step.task.body":
    "定向给执行器(如 AtomCode)发任务书,自动创建任务并执行。",
  "help.step.task.title": "3. 下发任务",
  "help.step.watch.body": "任务面板查看状态、实时输出、执行历史,可停止/回滚。",
  "help.step.watch.title": "4. 看任务",
