...
export const en: Record<DictKey, string> = {
  ...
  "groups.composition.three": "3-party",
  "groups.composition.two": "2-party",
  "groups.composition.threeAria": "3-party participant composition",
  "groups.composition.twoAria": "2-party participant composition",
  "groups.task.running": "Task running",
  "groups.task.attention": "Needs attention",
  "groups.task.complete": "Complete",
  "groups.task.none": "No tasks",
  ...
  "messages.send.testExecutor": "Test executor",
  "messages.send.testExecutor.auto": "Auto (by division prompt)",
  "messages.send.testExecutor.same": "Same executor",
  ...
  "tasks.output.fetchFailed": "Failed to fetch live output: {status}",
  "tasks.detail.fetchFailed": "Failed to fetch task detail: {status}",
  "tasks.liveness.recent": "Last activity · {when}",
  "tasks.liveness.justNow": "just now",
  "tasks.liveness.minutesAgo": "{n} min ago",
  "tasks.liveness.runningFor": "Running for {duration}",
